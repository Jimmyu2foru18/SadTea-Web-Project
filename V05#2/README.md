...
- **Example:** `https://example.github.io/th3viousgameus-website/`
...
- Note this will be the only way to host to github.io you need a custom domain for github pages 
- Alternatively you can host on Vercel.app it will connect to github and add in your Repository
- Hosting a Local server & Verciel has been my sucuess with this project
- Connect as intended in following steps.  
...
6. **Alternatively**
   - You can use Vercel.app to host your website
   - Sign up for Vercel.app
   - Connect your GitHub account
   - Add your repository
   - Deploy!
   - Vercel will provide you with a URL
   - You can use this URL or set up a custom domain
   - Share this URL with your audience!
