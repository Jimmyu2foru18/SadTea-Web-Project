...
class SetupOrchestrator extends BaseUIHandler {
  ...
  initializeSteps() {
    this.setupSteps = [
      new BasicInfoStep(this.configHandler, this),
      new YouTubeStep(this.configHandler, this),
      new StreamingStep(this.configHandler, this),
      new SocialMediaStep(this.configHandler, this),
      new MerchandiseStep(this.configHandler, this),
      new ContactFormStep(this.configHandler, this),
      new ThemeStep(this.configHandler, this),
      new CopyrightStep(this.configHandler, this)
    ];
  }
